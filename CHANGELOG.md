...
v3.4.1 (17/03/2019)
    ...
    - Thêm chức năng sau khi Admin xác nhận, sinh viên mới có thể xem chi tiết bài thi (formype@gmail.com) ✓
    - Thêm nhập nội dung ảnh cho câu hỏi và câu trả lời ✗
    - Thay đổi cách thức gửi đáp án của sinh viên (sữa lỗi đáp án chọn không trùng với đáp án trong bảng câu hỏi và đáp án có nội dung ảnh) ✓
...
v3.4.0 (18/02/2019)
    ...
    - Thêm thông báo lỗi ở một số chỗ (thêm sinh viên, thêm lớp,...) ✓
...
v3.3.0 (16/11/2018)
    ...
    - Thêm chức năng xem danh sách điểm của các bài thi và xuất file excel mà có lớp giảng viên đó đang quản lý tham gia ✓
...
v3.2.1 (07/11/2018)
    ...
    - Fix chức năng làm bài của sinh viên ✓
...
v3.2.0 (06/11/2018)
    ...
    - Nâng cấp chức năng tạo đề thi của quản trị viên ✓
    	- Có thể chọn môn, chọn kỳ học, chọn số câu hỏi của từng chương trong đề thi ✓
    	- Hệ thống sẽ lấy ngẫu nhiên các câu hỏi theo điều kiện đã chọn để tạo đề thi ✓
    	- Mỗi sinh viên khi chọn đề thi để làm bài sẽ có bộ câu hỏi được lấy từ bộ câu hỏi của đề thi sau khi đã được trộn thứ tự các câu hỏi và câu trả lời. ✓
    - Nâng cấp chức năng làm bài của sinh viên ✓
    	- Thay đổi giao diện trang làm bài/thi trực quan, nhiều chức năng hơn ✓
    	- Hệ thống sẽ lưu lại trạng thái làm bài và thời gian còn lại của sinh viên. Khi gặp sự cố hoặc sinh viên lỡ tay đóng trình duyệt đang mở, khi mở lại trang làm bài tập sẽ vẫn lưu lại trang thái các câu đã làm và thời gian còn lại. ✓
...
v3.1.0 (20/09/2018)
    ...
    - Thêm chức năng xem điểm từng sinh viên cho giảng viên ✓
    - Thêm file install.php để dễ dàng trong việc cài đặt & cấu hình sản phẩm lần đầu ✓
    - Thêm nhập dữ liệu bằng file thay vì nhập từng dòng (gồm thêm admin, giảng viên, sinh viên, bộ câu hỏi) ✓
...
v3.0.0 (08/03/2018)
    ...
    - Sinh viên, Giảng viên có thể tự cập nhật thông tin cá nhân (không cần thiết phải qua admin) ✓
    - Giảng viên, admin có thể chọn kỳ học, lớp để gửi thông báo (thay vì gửi cho tất cả như hiện tại) ✓
    - Sửa lại code theo đúng PHP Convention (PSR) ✓
    - Gộp các trang đăng nhập, quên mật khẩu lại làm 1 ✓
    - Kiểm tra dữ liệu tài khoản, email, tên lớp nhập vào ở Thêm, sửa Admin, sinh viên, giảng viên, lớp ngay lập tức sau khi nhập xong ✓
...
v2.0 (19/09/2017)
    ...
    - Model Sinh Viên:
    	...
    	+ Nhận thông báo trực tiếp từ giảng viên quản lý + admin ✓
    - Model Admin:
    	+ Gửi thông báo đến các giảng viên ✓
...
v1.0 (16/05/2017)
    ...
    - Giảng Viên:
    	+ Xem Điểm Của Sinh Viên Trong Các Lớp Đang Quản Lý ✓
    - Sinh Viên:
