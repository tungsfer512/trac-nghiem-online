...
function list_unit() {
    ...
    var success = function(result) {
        ...
        var json_data = $.parseJSON(result);
        if (json_data == "")
            div.append('<span class="title" style="color:red">Chưa có câu hỏi cho kỳ học và môn đã chọn, vui lòng thêm câu hỏi trước khi tạo đề thi, thêm câu hỏi <a href="/index.php?action=show_add_question">tại đây</a>!</span>');
        else {
