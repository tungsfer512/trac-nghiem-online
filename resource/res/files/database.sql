...
(1, 'admin', 'admin@ptit.edu.vn', 'e10adc3949ba59abbe56e057f20f883e', 'ADMIN', 1, '2024-04-15 01:17:23', 1, 'avatar-default.jpg', '2001-12-05');
...
CREATE TABLE `chats` (
  ...
  `time_sent` datetime,
  `chat_content` text COLLATE utf8_unicode_ci,
  `class_id` int(11)
...
CREATE TABLE `genders` (
  `gender_id` int(1),
  `gender_detail` varchar(20) COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `notifications` (
  ...
  `username` varchar(16) COLLATE utf8_unicode_ci,
  `name` varchar(50) COLLATE utf8_unicode_ci,
  `notification_title` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `questions` (
  ...
  `unit` int(2),
  `level_id` int(11),
  `question_content` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `answer_a` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `answer_b` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `answer_c` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `answer_d` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `correct_answer` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `question_id` int(11),
...
CREATE TABLE `statuses` (
  `status_id` int(1),
  `detail` varchar(50) COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `subjects` (
  `subject_id` int(11),
  `subject_detail` varchar(255) COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `tests` (
  `test_code` int(11),
  `test_name` varchar(255) COLLATE utf8_unicode_ci,
...
--
ALTER TABLE `admins`
  MODIFY `admin_id` int(11) AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `classes`
  MODIFY `class_id` int(11) AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `genders`
--
ALTER TABLE `genders`
  MODIFY `gender_id` int(1) AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `grades`
--
ALTER TABLE `grades`
  MODIFY `grade_id` int(11) AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `levels`
--
ALTER TABLE `levels`
  MODIFY `level_id` int(11) AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `notifications`
--
ALTER TABLE `notifications`
  MODIFY `notification_id` int(11) AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `permissions`
--
ALTER TABLE `permissions`
  MODIFY `permission` int(11) AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `statuses`
  MODIFY `status_id` int(1) AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `students`
--
ALTER TABLE `students`
  MODIFY `student_id` int(11) AUTO_INCREMENT;
...
--
ALTER TABLE `subjects`
  MODIFY `subject_id` int(11) AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `teachers`
--
ALTER TABLE `teachers`
  MODIFY `teacher_id` int(11) AUTO_INCREMENT;
...
--
ALTER TABLE `tests`
  MODIFY `test_code` int(11) AUTO_INCREMENT;
